              ...
              Hero(
                ...
                child: PageStorage(
                  ...
                  child: CarouselSlider(
                    items: widget.product.image.split(",").map((_element) {
                      return Container(
                        height: MediaQuery.of(context).size.height / 3,
                        width: MediaQuery.of(context).size.width,
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(_element),
                            fit: BoxFit.cover,
                          ),
                        ),
                      );
                    ...
                    options: CarouselOptions(
                      height: MediaQuery.of(context).size.height /
                          3, // You can adjust the height here
                      autoPlay:
                          true, // Example option, you can modify it according to your needs
